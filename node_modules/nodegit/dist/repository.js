...
function getPathHunks(repo, index, filePath, isStaged, additionalDiffOptions) {
  ...
  return Promise.resolve().then(function () {
    ...
    if (!(NodeGit.Status.file(repo, filePath) & NodeGit.Status.STATUS.WT_MODIFIED) && !(NodeGit.Status.file(repo, filePath) & NodeGit.Status.STATUS.INDEX_MODIFIED)) {
...
Repository.prototype.stageFilemode = function (filePath, stageNew, additionalDiffOptions) {
  ...
  return fse.remove(indexLock).then(function () {
    ...
    filePaths = filePaths.filter(function (p) {
      return NodeGit.Status.file(repo, p) & NodeGit.Status.STATUS.WT_MODIFIED || NodeGit.Status.file(repo, p) & NodeGit.Status.STATUS.INDEX_MODIFIED;
    });
